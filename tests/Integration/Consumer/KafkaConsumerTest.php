...
class KafkaConsumerTest extends TestCase
{
    ...
    {
        $consumer = new KafkaConsumer($this->connection, 'test-group');
    ...
    public function testPublishAndConsumeMessage(): void
    {
        ...
        // Publish messages
        $connection = new KafkaConnection($this->connection->getConfig());
        ...
        // Consume messages
        $consumer = new KafkaConsumer($this->connection, $group);
        $received = [];
    ...
    public function testConsumerWithCustomKafkaConfig(): void
    {
        ...
        $consumer = new KafkaConsumer($this->connection, 'custom-group', $customConfig);
    ...
    public function testConsumerWithSaslAuth(): void
    {
        ...
        $connectionWithAuth = new KafkaConnection($configWithAuth);
        $consumer = new KafkaConsumer($connectionWithAuth, 'auth-group');
    ...
    {
        $consumer = new KafkaConsumer($this->connection, 'destruct-group');
