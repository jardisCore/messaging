...
{
    /**
     * @param RabbitMqConnection|ExternalRabbitMqConnection $connection RabbitMQ connection instance
     */
    public function __construct(
        private readonly RabbitMqConnection|ExternalRabbitMqConnection $connection
    ) {
    }
